...
void TreeNode::insert(DBentry p)
{
...
void TreeNode::inorder(tree_node* p)
{
    if(p != NULL)
    {
...
void TreeNode::preorder(tree_node* p)
{
    if(p != NULL)
    {
        cout<<" "<<p->data.getName()<<" ";
...
void TreeNode::postorder(tree_node* p)
{
    if(p != NULL)
    {
...
void TreeNode::search(string key)
{
     bool found = false;
    if(isEmpty())
    {
...
void TreeNode::changeIPaddress(string p, int newnumber) {
    bool found = false;
    if(isEmpty())
    {
        cout<<" This Tree is empty! "<<endl;
